...
<iframe src="figures/race_distribution_of_years_lost.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>
...
<iframe src="figures/total_misconduct_tags_by_race.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>
...
<iframe src="figures/misconduct_tags_county_race.html" width="100%" height="900px" frameborder="0" scrolling="no"></iframe>
...
<iframe src="figures/disproportionality_index_exon_v_arrests.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>
...
<iframe src="figures/disproportionality_index_exon_v_incarcerated.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>
...
<iframe src="figures/age_distribution_by_race.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>
...
<iframe src="figures/breakdown_of_OM_by_race.html" width="100%" height="480px" frameborder="0" scrolling="no"></iframe>
...
**By County**
<iframe src="figures/predicted_prob_county.html" width="100%" height="580px" frameborder="0" scrolling="no"></iframe>

**By Race and County**
<iframe src="figures/predicted_prob_county_race.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>

**By Race**
<iframe src="figures/predicted_prob_race.html" width="100%" height="530px" frameborder="0" scrolling="no"></iframe>
...
The patterns in this data aren't isolated. They're systemic. Wrongful convictions and over-policing aren't just individual failures — they're symptoms of how power and bias operate in the justice system. Policymakers, researchers, and communities need to confront these patterns head-on. That means:

* Investigating misconduct, not burying it.
* Prioritizing accountability, not public image.
* Investing in communities, not just carceral infrastructure.
