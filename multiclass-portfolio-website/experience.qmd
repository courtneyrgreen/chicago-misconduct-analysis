...
toc-depth: 2
---
## [Guidehouse](https://guidehouse.com/){target="_blank"}  
...
- Analyzed downscaled climate models (e.g., CMIP6 variants) to assess fitness for localized 

`Data Automation` `Sustainability Analytics` `Energy forecasting` `Database Management` `Climate Risk Analysis` `Dashboard Development` `Time Series Forecasting`
...
`Program Support` `Data Analysis` `Database Management` `Performance Metrics` 
